...
def main():
    ...
    print("""
  ######################################
  # CINE_ADDIZEUS Development Environment Setup #
  ######################################

  This script will create your CINE_ADDIZEUS dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your CINE_ADDIZEUS project folder:
    [Arma 3 installation directory]\\{} => CINE_ADDIZEUS project folder
    P:\\{}                              => CINE_ADDIZEUS project folder
